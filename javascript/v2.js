...
d3.text("Data/v2/wordcloud_cuisines", function (text) {
    ...
    var wordcloudText = data[0][0];
    drawWordCloud(wordcloudText);
    ...
    function update_wordcloud(filename) {
        d3.text(filename, function (text) {
            var updatedData = d3.csv.parseRows(text);
            console.log(updatedData)
            console.log(updatedData[0])
            var updateWordcloudText = updatedData[0][0];
            drawWordCloud2(updateWordcloudText);
            console.log(updateWordcloudText)
